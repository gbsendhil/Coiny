...
import com.binarybricks.coiny.network.API_KEY
import com.binarybricks.coiny.network.APP_NAME
...
interface API {
    ...
    @Headers(API_KEY)
    @GET("pricemultifull")
    fun getPricesFull(@Query("fsyms") fromSymbol: String, @Query("tsyms") toSymbol: String,
                      @Query("extraParams") apiKey: String = APP_NAME): Single<JsonObject>
    ...
    @Headers(API_KEY)
    @GET("price")
    fun getPrice(@Query("fsym") fromSymbol: String, @Query("tsyms") toSymbol: String,
                 @Query("e") exchange: String, @Query("extraParams") apiKey: String = APP_NAME): Single<JsonObject>
